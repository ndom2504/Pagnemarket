export const CITIES: Record<string, string[]> = {
  ...
  LA: ["Vientiane", "Pakse", "Savannakhet", "Luang Prabang", "Thakhek", "Phonsavan", "Xam Neua", "Muang Xay", "Attapeu", "Luang Namtha"],
...
export function citiesFor(iso?: string | null): string[] {
